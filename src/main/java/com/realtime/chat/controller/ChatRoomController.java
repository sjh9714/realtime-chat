...
public class ChatRoomController {
  ...
  public ResponseEntity<ChatRoomResponse> createDirectRoom(
      @AuthenticationPrincipal Long userId, @Valid @RequestBody CreateDirectRoomRequest request) {
  ...
  public ResponseEntity<ChatRoomResponse> createGroupRoom(
      @AuthenticationPrincipal Long userId, @Valid @RequestBody CreateGroupRoomRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
