...
@ActiveProfiles("demo")
class PublicDemoProfileBoundaryIntegrationTest extends BaseIntegrationTest {
  ...
  @Test
  void publicDemoSeedsAccountsWithoutLoadingE2eDiagnosticsOrFailureInjection() {
    assertThat(context.getEnvironment().getActiveProfiles()).contains("test", "demo");
    assertThat(context.getBeansOfType(DemoDataConfig.class)).hasSize(1);
  ...
  @Test
  void publicDemoDoesNotExposeE2eDiagnosticsEndpoint() {
