...
class JwtTokenProviderTest {
  ...
  void setUp() {
    jwtTokenProvider =
        new JwtTokenProvider(
            "test-jwt-secret-key-must-be-at-least-256-bits-long-for-hs256-algorithm", 86400000L);
  }
  ...
  void validateExpiredToken() {
    JwtTokenProvider expiredProvider =
        new JwtTokenProvider(
            "test-jwt-secret-key-must-be-at-least-256-bits-long-for-hs256-algorithm", 0L // 즉시 만료
            );
