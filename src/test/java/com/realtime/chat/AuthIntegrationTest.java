...
class AuthIntegrationTest extends BaseIntegrationTest {
  ...
  void signupAndLoginFlow() throws Exception {
    ...
    ResponseEntity<AuthResponse> signupResponse =
        restTemplate.postForEntity(baseUrl + "/signup", signupRequest, AuthResponse.class);
    ...
    ResponseEntity<AuthResponse> loginResponse =
        restTemplate.postForEntity(baseUrl + "/login", loginRequest, AuthResponse.class);
    ...
    ResponseEntity<String> unauthorizedResponse =
        restTemplate.getForEntity("http://localhost:" + port + "/api/rooms", String.class);
  ...
  void signupDuplicateEmail() {
    ...
    ResponseEntity<String> response =
        restTemplate.postForEntity(baseUrl + "/signup", request, String.class);
