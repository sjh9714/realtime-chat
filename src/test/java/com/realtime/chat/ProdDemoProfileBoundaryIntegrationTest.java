...
class ProdDemoProfileBoundaryIntegrationTest extends BaseIntegrationTest {
  ...
  @Test
  void prodProfileDisablesDemoSeedAndEveryE2eOnlyBeanWhenDemoIsAlsoActive() {
    assertThat(context.getEnvironment().getActiveProfiles())
        .contains("test", "prod", "demo");
    ...
    assertThat(context.getBeansOfType(PersistenceFailureProbe.class))
        .hasSize(1)
        .allSatisfy((name, probe) -> assertThat(probe).isInstanceOf(NoopPersistenceFailureProbe.class));
  }

  @Test
  void prodAndDemoProfilesDoNotExposeE2eDiagnosticsEndpoint() {
