...
| 추가 측정 예정 | 1,000 session send-to-receive latency | benchmark 미측정 | local receiver matrix repeat3는 시나리오 검증이며 production/mixed benchmark가 아님 |
| 추가 측정 예정 | 1,000 session delivery completeness | benchmark 미측정 | local receiver matrix repeat3는 시나리오 검증이며 production/mixed benchmark가 아님 |
...
| 아직 측정하지 않은 것 | 상태 |
|---|---|
| send-to-receive p95 latency | 50/500/1,000-user local receiver matrix는 시나리오 검증, 1,000 session send-to-receive latency \| benchmark 미측정 |
| 모든 전송 메시지의 delivery completeness | 50/500/1,000-user local receiver matrix는 시나리오 검증, 1,000 session delivery completeness \| benchmark 미측정 |
