...
flowchart LR
    ...
    App1 -->|"CONNECT JWT auth"| Auth["WebSocketAuthInterceptor"]
    App1 -->|"SUBSCRIBE membership check"| Authz["WebSocketAuthorizationInterceptor"]
    App1 -->|"SEND membership check"| Send["ChatMessageController"]
    ...
    App1 -->|"room topic broadcast"| Client
    App2 -->|"room topic broadcast"| OtherClients["Other Clients"]
